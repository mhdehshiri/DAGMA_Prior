...
Here the Hadamard product of the inverse of each component in the prior knowledge Matrix $$ B $$ ($$ B^* $$) and adjacency matrix $W \in \mathbb  is replaced with the original sparsity term in DAGMA(https://github.com/kevinsbello/dagma#readme)
